...
Test('Function prototype documentation', t => {
  ...
  t.assert(!output[1].context.static, 'prototype not static');
  ...
  t.assert(output[4].context.static, 'static property is static');
  ...
  t.assert(output[5].context.static, 'static property is static');
  ...
  t.assert(output[8].context.static, 'static property is static');
